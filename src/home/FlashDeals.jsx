    ...
    <>
     <section className=' xs:px-[10px] sm:px-[20px] md:px-[90px] mx-auto pt-[10px] xs:pb-[30px] sm:pb-[40px] md:pb-[50px]'>
        <div className=' flex items-center justify-between'>
          <h2 className=' font-poppins font-medium xs:text-[16px] sm:text-[16px] md:text-[26px] sm:leading-[20px] md:leading-[39px] text-black38'>Flash Deals</h2>
        ...
        <div className=' xs:mt-[10px] sm:mt-[15px] md:mt-[20px] grid xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-4 xs:gap-[10px] sm:gap-[15px] md:gap-[26px]'>
            <div className=' xs:h-[280px]  sm:h-[280px] w-full md:h-[430px] border-[1px] border-[#E9E9E9] xs:rounded-[4px] sm:rounded-[5px] md:rounded-[10px] bg-white xs:p-[4px] sm:p-[5px] md:p-[10px] '>
                 <div className=' relative w-full h-[277px]  rounded-[10px] '>
                   <img src={flash1} alt="" className='xs:rounded-[4px] sm:rounded-[5px]  md:rounded-[10px] xs:h-[167px] sm:h-[167px] w-full  md:h-full bg-[#e9e9e9]' />
                      ...
                      <div className=' absolute top-0 left-0 px-[5px] py-[2px] xs:rounded-tl-[4px]  rounded-tl-[9px] bg-gradient-to-r  from-[#FF7A00] to-[#FFB800] rounded-tr-[2px]  rounded-bl-[2px] rounded-br-[2px]'>
                              <p className=' font-poppins xs:text-[10px] sm:text-[8px] md:text-[14px] sm:leading-[12px] md:leading-[21px] font-[500]  text-[#fafafa]'>-25% OFF</p>
                      </div>
